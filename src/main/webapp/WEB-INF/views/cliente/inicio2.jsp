                                        ...
                                        <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="../resources/imagen/carrucel img1.jpg" class="d-block w-100" alt=""
                                                        height="300">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="../resources/imagen/Jardín_San_Felipe.jpg" class="d-block w-100"
                                                        alt="" height="300">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="../resources/imagen/mostrario.jpg" class="d-block w-100" alt=""
                                                        height="300">
                                                </div>
                                            </div>
